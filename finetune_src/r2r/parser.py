...
def parse_args():
    ...
    parser.add_argument('--cooccurrence_num', type=int, default=10)
    parser.add_argument('--adapter_lr', type=float, default=0.1, help="the adapter learning rate")
    parser.add_argument("--temperature", default=0.5, type=float, help="hyperparameter for contrastive loss")
    parser.add_argument('--CONSOLE_test', action='store_true', default=False)
