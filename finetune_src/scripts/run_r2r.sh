...
CUDA_VISIBLE_DEVICES='0' python r2r/main.py $flag --eval_first \
      --aug ../datasets/R2R/annotations/R2R_aug_landmark_co-occurrence_chatgpt_enc.json \
      ...
      --output_dir ../datasets/R2R/trained_models/vitbase-finetune/CONSOLE
...
CUDA_VISIBLE_DEVICES='0' python r2r/main.py $flag \
      --resume_file ../datasets/R2R/trained_models/vitbase-finetune/CONSOLE/ckpts/best_val_unseen \
      --output_dir ../datasets/R2R/trained_models/vitbase-finetune/CONSOLE_test \
